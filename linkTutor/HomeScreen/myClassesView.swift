                ...
                VStack(alignment: .leading){
                    ...
                    VStack(spacing: 10) {
                        if let classesForThirdToSelectedDate = classesForThirdToSelectedDate(), !classesForThirdToSelectedDate.isEmpty {
                            ForEach(classesForThirdToSelectedDate.filter { $0.studentUid == userId && $0.requestAccepted == 1 }, id: \.id) { enrolledClass in
                                    if enrolledClass.studentUid == userId {
                                    calenderPage(className: enrolledClass.className, tutorName: enrolledClass.teacherName, startTime: enrolledClass.startTime.dateValue())
                                    }
                                }
                    ...
                    VStack(spacing: 10) {
                        if let classesForFourthToSelectedDate = classesForFourthToSelectedDate(), !classesForFourthToSelectedDate.isEmpty {
                            ForEach(classesForFourthToSelectedDate.filter { $0.studentUid == userId && $0.requestAccepted == 1 }, id: \.id) { enrolledClass in
                                    if enrolledClass.studentUid == userId && enrolledClass.requestAccepted == 1 {
                                    calenderPage(className: enrolledClass.className, tutorName: enrolledClass.teacherName, startTime: enrolledClass.startTime.dateValue())
                                    }
                                }
                        } else {
                    ...
                    VStack(spacing: 10) {
                        if let classesForFifthToSelectedDate = classesForFifthToSelectedDate(), !classesForFifthToSelectedDate.isEmpty {
                            ForEach(classesForFifthToSelectedDate.filter { $0.studentUid == userId && $0.requestAccepted == 1 }, id: \.id) { enrolledClass in
                                    if enrolledClass.studentUid == userId && enrolledClass.requestAccepted == 1 {
                                    calenderPage(className: enrolledClass.className, tutorName: enrolledClass.teacherName, startTime: enrolledClass.startTime.dateValue())
                                    }
                                }
                    ...
                    VStack(spacing: 10) {
                        if let classesForSixthToSelectedDate = classesForSixthToSelectedDate(), !classesForSixthToSelectedDate.isEmpty {
                            ForEach(classesForSixthToSelectedDate.filter { $0.studentUid == userId && $0.requestAccepted == 1 }, id: \.id) { enrolledClass in
                                    if enrolledClass.studentUid == userId && enrolledClass.requestAccepted == 1 {
                                    calenderPage(className: enrolledClass.className, tutorName: enrolledClass.teacherName, startTime: enrolledClass.startTime.dateValue())
                                    }
                                }
                    ...
                    VStack(spacing: 10) {
                        if let classesForSeventhToSelectedDate = classesForSeventhToSelectedDate(), !classesForSeventhToSelectedDate.isEmpty {
                            ForEach(classesForSeventhToSelectedDate.filter { $0.studentUid == userId && $0.requestAccepted == 1 }, id: \.id) { enrolledClass in
                                    if enrolledClass.studentUid == userId && enrolledClass.requestAccepted == 1 {
                                    calenderPage(className: enrolledClass.className, tutorName: enrolledClass.teacherName, startTime: enrolledClass.startTime.dateValue())
                                    }
                                }
